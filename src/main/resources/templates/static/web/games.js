...
function createTable_Games(){
    ...
    for (var i = 0; i < games.games.length; i++){
        ...
        cell.innerHTML = games.games[i].id;
        cell_2.innerHTML = games.games[i].created;
...
function createTable_Ranking(){
    ...
    for (var i = 0; i < sorted_array.length; i ++){
        ...
        cell_1.innerHTML = sorted_array[i].username;
        cell_2.innerHTML = sorted_array[i].score;
        cell_3.innerHTML = sorted_array[i].Win;
        cell_4.innerHTML = sorted_array[i].Tie;
        cell_5.innerHTML = sorted_array[i].Lose;
        }
}
